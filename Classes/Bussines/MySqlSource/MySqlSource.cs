...
namespace zIinz_3_bigdata.Classes.Bussines.MySqlSource
{
    [DataContract]
    public class MySqlSource : AutoInitXmlStorage<MySqlSource>, IDbSource, IDisposable
    {
        [IgnoreDataMember]
        ...
        public bool Connect()
        {
            ...
            try
            {
                Connection = new MySqlConnection($"SERVER={Host};DATABASE={Schema};UID={Login};PASSWORD={Password};port={Port};charset=utf8");
